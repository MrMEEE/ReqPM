...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="local",
                        help_text="Authentication backend used for this user",
                        max_length=10,
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["auth_backend"], name="users_auth_ba_d62a94_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(fields=["api_key"], name="users_api_key_6038b9_idx"),
        ),
    ]
